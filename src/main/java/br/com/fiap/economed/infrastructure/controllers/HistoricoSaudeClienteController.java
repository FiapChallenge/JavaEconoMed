...
import br.com.fiap.economed.infrastructure.controllers.dto.historicoSaudeCliente.DetalhesHistoricoSaudeClienteDto;
import br.com.fiap.economed.infrastructure.persistence.dbEntities.HistoricoSaudeClienteDb;
import br.com.fiap.economed.infrastructure.persistence.repositories.HistoricoSaudeClienteRepository;
...
public class HistoricoSaudeClienteController {
    ...
    public ResponseEntity<DetalhesHistoricoSaudeClienteDto> cadastrar(
        ...
        var historicoSaudeCliente = new HistoricoSaudeClienteDb(historicoSaudeClienteDto);
