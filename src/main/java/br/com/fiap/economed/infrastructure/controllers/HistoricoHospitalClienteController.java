...
import br.com.fiap.economed.infrastructure.controllers.dto.historicoHospitalCliente.AtualizacaoHistoricoHospitalClienteDto;
...
import br.com.fiap.economed.infrastructure.controllers.dto.historicoHospitalCliente.CadastroHistoricoHospitalClienteDto;
import br.com.fiap.economed.infrastructure.controllers.dto.historicoHospitalCliente.DetalhesHistoricoHospitalClienteDto;
import br.com.fiap.economed.infrastructure.persistence.dbEntities.HistoricoHospitalClienteDb;
import br.com.fiap.economed.infrastructure.persistence.repositories.HistoricoHospitalClienteRepository;
...
public class HistoricoHospitalClienteController {
    ...
    public ResponseEntity<DetalhesHistoricoHospitalClienteDto> cadastrar(
        ...
        var historicoHospitalCliente = new HistoricoHospitalClienteDb(historicoHospitalClienteDto);
